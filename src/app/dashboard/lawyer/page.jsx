...
const actions = [
  {
    ...
    desc: "Create, edit or delete your public listing that clients see.",
    cta: "Open profile",
    Icon: FaUserPen,
  },
  {
    ...
    desc: "Review incoming client requests and accept or reject them.",
    cta: "View requests",
...
const LawyerDashboardHomePage = async () => {
  ...
  const firstName = user?.name?.trim()?.split(" ")[0] || "Counsel";
        ...
        <header className="relative overflow-hidden bg-gradient-to-br from-[#0B1526] via-[#14213D] to-[#0B1526] px-6 py-9 sm:px-10 sm:py-11">
          ...
          <div className="relative">
            ...
            <h1
              ...
              style={headingFont}
            >
              Welcome back, <span className="text-[#E2B93B]">{firstName}</span>
            </h1>
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-[#E8DCC8]/85 sm:text-base">
              Your publishing fee is paid and your account is active. Manage your
              listing and respond to clients from here.
            </p>

            <span className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#15803D]/40 bg-[#ECFDF3] px-3.5 py-1.5 text-xs font-semibold text-[#166534]">
              <span className="relative flex h-2 w-2" aria-hidden="true">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#15803D] opacity-60 motion-reduce:animate-none" />
